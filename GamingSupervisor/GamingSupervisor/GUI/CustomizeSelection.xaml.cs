...
namespace GamingSupervisor
{
    ...
    public partial class CustomizeSelection : Page
    {
        public CustomizeSelection()
        {
            ...
            MainWindow.Description.Text = "Here you can customize what the Gaming Supervisor will help you with. Setting have already been selected for you based on what difficulty you selected.";
            ...
            MainWindow.Description.Text += "\n\n";
            MainWindow.Description.Text += "The item helper will help you with deciding when to use the items in your inventory.";
            MainWindow.Description.Text += "\n\n";
